                ...
                <AboutSectionContainerTable>
                  <tbody>
                    ...
                    <AboutSectionContainerRow>
                      ...
                      <AboutSectionItem>
                        {guidebookDetails.capacity}
                      </AboutSectionItem>
                    </AboutSectionContainerRow>

                    {guidebookDetails.checkininstr && (
                      <AboutSectionContainerRow>
                        <AboutSectionItem>
                    ...
                    {guidebookDetails.checkoutinstr && (
                      <AboutSectionContainerRow>
                        <AboutSectionItem>
